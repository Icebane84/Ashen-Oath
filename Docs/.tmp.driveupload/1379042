...
| `UAshenUserWidget_WhiteFlameResolutionHUD` | [`AshenUserWidget_WhiteFlameResolutionHUD.h`](file:///c:/Users/Chris/Ashen%20Oath%20Unreal%20Engine/AshenOath/Source/AshenOath/UI/AshenUserWidget_WhiteFlameResolutionHUD.h) | Radiant HUD displaying duration remaining and live total debt eradicated |
| `UAshenUserWidget_CatharsisReadinessHUD` | [`AshenUserWidget_CatharsisReadinessHUD.h`](file:///c:/Users/Chris/Ashen%20Oath%20Unreal%20Engine/AshenOath/Source/AshenOath/UI/AshenUserWidget_CatharsisReadinessHUD.h) | Dual-gauge UI showing Kaelen Resolve vs Serafina Burnout convergence readiness |
| `UAshenWhiteFlamePostProcessAdapter` | [`AshenWhiteFlamePostProcessAdapter.h`](file:///c:/Users/Chris/Ashen%20Oath%20Unreal%20Engine/AshenOath/Source/AshenOath/UI/AshenWhiteFlamePostProcessAdapter.h) | High-key exposure, golden bloom halos & complete erasure of dark shadow vignettes |
