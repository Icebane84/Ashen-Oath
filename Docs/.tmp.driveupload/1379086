...
| `UAshenUserWidget_MemoryLoomHUD` | [`AshenUserWidget_MemoryLoomHUD.h`](file:///c:/Users/Chris/Ashen%20Oath%20Unreal%20Engine/AshenOath/Source/AshenOath/UI/AshenUserWidget_MemoryLoomHUD.h) | Diegetic HUD displaying active thread counts, tension meters & transference rates |
| `UAshenUserWidget_ThreadSnapWarningHUD` | [`AshenUserWidget_ThreadSnapWarningHUD.h`](file:///c:/Users/Chris/Ashen%20Oath%20Unreal%20Engine/AshenOath/Source/AshenOath/UI/AshenUserWidget_ThreadSnapWarningHUD.h) | Tactical warning HUD flashing when filament rupture is imminent |
| `UAshenLuminousFilamentPostProcessAdapter` | [`AshenLuminousFilamentPostProcessAdapter.h`](file:///c:/Users/Chris/Ashen%20Oath%20Unreal%20Engine/AshenOath/Source/AshenOath/UI/AshenLuminousFilamentPostProcessAdapter.h) | Golden anamorphic lens flare bloom and radiant dispersion around filaments |
